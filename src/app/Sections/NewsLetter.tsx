...
const NewsLetter = () => {
    return (
        <section className='relative w-10/12 mx-auto my-20 flex items-center justify-center'>
            <div className='absolute'>
                <h1 className='z-0 text-[#212121] text-[6rem] md:text-[7rem] leading-none font-extrabold opacity-[0.07]'>
                    NEWSLETTER
                </h1>
            </div>
